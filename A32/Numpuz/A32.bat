...
SET JARNAME=NumPuz-Client.jar
SET JAROUT=numpuz-jar.out
SET JARERR=numpuz-jar.err

SET JARNAME2=NumPuz-Server.jar
...
SET MAINCLASSSRC=src/Main/Client.java
SET MAINCLASSSRC2=src/Main/Server.java
SET MAINCLASSBIN=Main.Client
SET MAINCLASSBIN2=Main.Server
