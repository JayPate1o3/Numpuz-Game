 ...
 * -------------------------------------------------------------
 */
VENOM_void bErrorPrint(VENOM_char* fmt, ...);
VENOM_void displayBuffer(BufferReader* ptr_Buffer);
VENOM_long getFileSize(VENOM_char* fname);
VENOM_intg isNumber(const VENOM_char* ns);
VENOM_void startReader(VENOM_char*, VENOM_char*, VENOM_char, VENOM_intg, VENOM_intg);
...
VENOM_intg mainReader(VENOM_intg argc, VENOM_char** argv) {

	/* Create source input buffer */
	VENOM_char* program = argv[0];
	VENOM_char* input = argv[2];
	VENOM_char mode = MODE_FIXED;
	VENOM_intg size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
VENOM_void startReader(VENOM_char* program, VENOM_char* input, VENOM_char mode, VENOM_intg size, VENOM_intg increment) {

	ReaderPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	VENOM_intg loadSize = 0;		/* the size of the file loaded in the buffer */
	VENOM_char symbol;			/* symbol read from input file */
...
VENOM_void bErrorPrint(VENOM_char* fmt, ...) {
	...
	(VENOM_void)vfprintf(stderr, fmt, ap);
	va_end(ap);
